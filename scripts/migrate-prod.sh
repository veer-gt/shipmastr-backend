      ...
      const indexRows = await prisma.$queryRawUnsafe(`
        ...
        WHERE schemaname = current_schema()
          AND indexname IN (
            ...
            'PaymentAttempt_obligationId_merchantId_obligationCollectionRail_idx',
            ...
            'ProviderPolicyDecisionAudit_provider_environment_operation_evaluatedAt_idx',
      ...
      const foreignKeyRows = await prisma.$queryRawUnsafe(`
        ...
        WHERE n.nspname = current_schema()
          ...
          AND c.conname IN (
            ...
            'PaymentAttempt_obligationId_merchantId_obligationCollectionRa_fkey',
