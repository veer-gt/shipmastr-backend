...
readonly EXPECTED_MIGRATION_1="20260827120000_pgo_1_payment_orchestration"
readonly EXPECTED_MIGRATION_2="20260829120000_pgo_1_final_fix_observation_truth"
...
const expectedSchemaObjects = [
  ...
  "foreign_key:PaymentAttempt_obligationId_merchantId_obligationCollectionRa_f",
  ...
  "index:PaymentAttempt_obligationId_merchantId_obligationCollectionRail",
  ...
  "index:ProviderObservationDelivery_pkey",
  ...
  "index:ProviderObservationRejection_pkey",
  ...
  "index:ProviderPolicyDecisionAudit_provider_environment_operation_eval",
    ...
    if (phase === "postcheck") {
      ...
      const tableRows = await prisma.$queryRawUnsafe(`
        ...
        WHERE table_schema = current_schema()
          AND table_name IN (
            'PaymentAttempt',
            'PaymentAttentionSignal',
            'PaymentNormalizedFactOutbox',
            'PaymentObligation',
            'PaymentOutcomeTransition',
            'ProviderObservation',
            'ProviderObservationDelivery',
      ...
      const indexRows = await prisma.$queryRawUnsafe(`
        ...
        WHERE schemaname = current_schema()
          AND indexname IN (
            'PaymentAttempt_id_obligationId_merchantId_key',
            'PaymentAttempt_merchantId_idx',
            'PaymentAttempt_obligationId_idx',
            'PaymentAttempt_obligationId_merchantId_obligationCollectionRail',
            'PaymentAttempt_outcomeStatus_idx',
            'PaymentAttempt_pkey',
            'PaymentAttempt_provider_environment_idx',
            'PaymentAttempt_reviewStatus_idx',
            'PaymentAttentionSignal_attemptId_createdAt_idx',
            'PaymentAttentionSignal_merchantId_createdAt_idx',
            'PaymentAttentionSignal_obligationId_createdAt_idx',
            'PaymentAttentionSignal_pkey',
            'PaymentNormalizedFactOutbox_attemptId_createdAt_idx',
            'PaymentNormalizedFactOutbox_merchantId_createdAt_idx',
            'PaymentNormalizedFactOutbox_obligationId_createdAt_idx',
            'PaymentNormalizedFactOutbox_pkey',
            'PaymentObligation_checkoutId_idx',
            'PaymentObligation_id_merchantId_collectionRail_key',
            'PaymentObligation_id_merchantId_key',
            'PaymentObligation_merchantId_idx',
            'PaymentObligation_pkey',
            'PaymentObligation_status_idx',
            'PaymentOutcomeTransition_attemptId_createdAt_idx',
            'PaymentOutcomeTransition_merchantId_createdAt_idx',
            'PaymentOutcomeTransition_obligationId_createdAt_idx',
            'PaymentOutcomeTransition_pkey',
            'ProviderObservationDelivery_attemptId_idx',
            'ProviderObservationDelivery_merchantId_idx',
            'ProviderObservationDelivery_obligationId_idx',
            'ProviderObservationDelivery_observationId_idx',
            'ProviderObservationDelivery_pkey',
            'ProviderObservationInterpretation_attemptId_idx',
            'ProviderObservationInterpretation_merchantId_idx',
            'ProviderObservationInterpretation_obligationId_idx',
            'ProviderObservationInterpretation_pkey',
            'ProviderObservationRejection_attemptId_detectedAt_idx',
            'ProviderObservationRejection_merchantId_detectedAt_idx',
            'ProviderObservationRejection_securityAlertStatus_detectedAt_idx',
            'ProviderObservationRejection_pkey',
            'ProviderObservation_attemptId_idx',
            'ProviderObservation_id_attemptId_obligationId_merchantId_key',
            'ProviderObservation_merchantId_idx',
            'ProviderObservation_obligationId_idx',
            'ProviderObservation_pkey',
            'ProviderObservation_providerEventId_idx',
            'ProviderObservation_providerTransactionRef_idx',
            'ProviderObservation_provider_environment_idx',
            'ProviderPolicyDecisionAudit_attemptId_evaluatedAt_idx',
            'ProviderPolicyDecisionAudit_decision_evaluatedAt_idx',
            'ProviderPolicyDecisionAudit_merchantId_evaluatedAt_idx',
            'ProviderPolicyDecisionAudit_pkey',
            'ProviderPolicyDecisionAudit_provider_environment_operation_eval',
            'ReconciliationReviewHistory_attemptId_createdAt_idx',
            'ReconciliationReviewHistory_merchantId_createdAt_idx',
            'ReconciliationReviewHistory_obligationId_createdAt_idx',
            'ReconciliationReviewHistory_pkey',
            'RefundDueCase_attemptId_detectedAt_idx',
            'RefundDueCase_merchantId_detectedAt_idx',
            'RefundDueCase_obligationId_detectedAt_idx',
            'RefundDueCase_pkey',
            'payment_attempt_one_unresolved_per_obligation',
            'payment_attempt_request_idempotency',
            'payment_fact_dedupe',
            'provider_observation_dedupe',
            'provider_observation_interpretation_dedupe',
            'provider_observation_scoped_event_body',
            'provider_security_alert_dedupe',
            'refund_due_case_dedupe'
          )
      `);
      const foreignKeyRows = await prisma.$queryRawUnsafe(`
        ...
        WHERE n.nspname = current_schema()
          AND c.contype = 'f'
          AND c.conname IN (
            'PaymentAttentionSignal_attemptId_obligationId_merchantId_fkey',
            'PaymentAttentionSignal_obligationId_merchantId_fkey',
            'PaymentAttentionSignal_observationId_attemptId_obligat_fkey',
            'PaymentAttempt_obligationId_merchantId_obligationCollectionRa_f',
            'PaymentNormalizedFactOutbox_attemptId_obligationId_mer_fkey',
            'PaymentNormalizedFactOutbox_obligationId_merchantId_fkey',
            'PaymentNormalizedFactOutbox_triggeringObservationId__fkey',
            'PaymentOutcomeTransition_attemptId_obligationId_merchan_fkey',
            'PaymentOutcomeTransition_obligationId_merchantId_fkey',
            'PaymentOutcomeTransition_triggeringObservationId_attemptI_fkey',
            'ProviderObservationDelivery_observationId_attemptId_oblig_fkey',
            'ProviderObservationInterpretation_originalObservationI_fkey',
            'ProviderObservation_attemptId_obligationId_merchantId_fkey',
            'ProviderObservation_obligationId_merchantId_fkey',
            'ReconciliationReviewHistory_attemptId_obligationId_merc_fkey',
            'ReconciliationReviewHistory_obligationId_merchantId_fkey',
            'ReconciliationReviewHistory_triggeringObservationId_a_fkey',
            'RefundDueCase_attemptId_obligationId_merchantId_fkey',
            'RefundDueCase_obligationId_merchantId_fkey',
            'RefundDueCase_verificationObservationId_attemptId_obli_fkey'
          )
      `);
      schemaObjects = [
