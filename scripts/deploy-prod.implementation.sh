...
# I5B-1: not a direct deployment entry point.
if [[ "${SHIPMASTR_GOVERNED_WRAPPER:-}" != "1" ]]; then
  echo "SHIPMASTR_DEPLOYMENT_BLOCKED_DIRECT_IMPLEMENTATION_EXECUTION" >&2
  exit 64
fi
unset SHIPMASTR_GOVERNED_WRAPPER
