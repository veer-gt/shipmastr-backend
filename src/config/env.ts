...
const schema = z.object({
  ...
  H2B_SHOPIFY_BODY_LIMIT_BYTES: z.coerce.number().int().min(1024).max(256 * 1024).default(256 * 1024),
  H2B_WOOCOMMERCE_BODY_LIMIT_BYTES: z.coerce.number().int().min(1024).max(256 * 1024).default(256 * 1024),
  H2B_MAGENTO_BODY_LIMIT_BYTES: z.coerce.number().int().min(1024).max(256 * 1024).default(64 * 1024),
